  ...
  return (
    <div className="px-4 py-6">
      <div className="flex flex-col md:flex-row justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Bubble Tea Challenge</h1>
          <p className="text-gray-600">Making 100 different teas for my wife in 2026</p>
        </div>
                ...
                <div className="flex justify-between items-start mb-4">
                  ...
                  {tea.isMade ? (
                    <span className="text-green-600 text-xs font-bold flex items-center">
                     ...
                     <span className="text-gray-400 text-xs">To Do</span>
                  )}
                </div>
